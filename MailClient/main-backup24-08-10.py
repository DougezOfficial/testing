        ...
        def attach(self):
            ...
            if filenames != []:
                for filename in filenames:
                    ...
                    encoders.encode_base(p)
                    p.add_header("Content-Disposition", f"attachment; filename={filename}")
                    self.msg.attach(p)
                    if not self.attachmentlbl.text().endswith(":"):
                        self.attachmentlbl.setText(self.attachmentlbl.text() + ",")
                    self.attachmentlbl.setText(self.attachmentlbl.text() + " " + filename)
